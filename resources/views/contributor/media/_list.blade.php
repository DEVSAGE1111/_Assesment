        ...
        @foreach($media as $medium)
            <tr>
                ...
                <td>
                    ...
                    <a href="{{ route('media.show', $medium) }}" title="@lang('media.download')" class="btn btn-primary btn-sm">
                        <x-icon name="download" />
                    </a>

                    <form action="{{ route('media.destroy', $medium) }}" method="POST" class="form-inline" data-confirm="@lang('forms.media.delete')">
                        @method('DELETE')
                        @csrf
